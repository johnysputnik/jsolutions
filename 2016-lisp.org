...
*** NEXT Manipulating Sequences
    ...
    As lisp is a processor of lists, there are a lot of functions for
    manipulating sequences, here are some of them:
...
(delete #\t "test")
;; => "es"
(delete-duplicates '(1 2 2 3 4 5 5 6 6 6))
;; => (1 2 3 4 5 6)
(delete-if #'evenp '(1 2 3 4 5 6))
;; => (1 3 5)
